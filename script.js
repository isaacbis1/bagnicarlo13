...
function authenticateUser(username) {
  ...
  // Mostra il container di pagamento dopo il login
...
async function pagaPrenotazione() {
  ...
  // Reindirizza direttamente al Payment Link (che ha success_url impostato su tomorrow.html)
  const paymentLink = "https://book.stripe.com/7sI4hZ5tBgRybvOeUV";
